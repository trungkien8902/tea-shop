        ...
        <div class="u-container-style u-group u-shape-rectangle u-group-1">
            <div class="u-container-layout u-container-layout-1">
                ...
                <div class="u-form u-form-1">
                    <form action="{{route('home.contact')}}" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" style="padding: 15px;" source="email" name="form" method="POST">
                    @csrf
                        <div class="u-form-group u-form-name u-label-none">
                            <label for="name-6797" class="u-label">Họ tên</label>
                        ...
                        <div class="u-form-group u-form-message u-label-none">
                            <label for="message-6797" class="u-label">Điện thoại</label>
                            <input type="text" id="text-8ede" name="text" class="u-border-3 u-border-custom-color-2 u-custom-font u-input u-input-rectangle u-text-custom-color-4 u-input-4" placeholder="Số điện thoại">
                        </div>
                        <div class="u-form-group u-label-none">
                            <label for="text-8ede" class="u-label">Nội dung</label>
                            <textarea placeholder="Nội dung" rows="3" cols="50" id="message-6797" name="message" class="u-border-3 u-border-custom-color-2 u-custom-font u-input u-input-rectangle u-text-custom-color-4 u-input-3" required=""></textarea>
                        </div>
                        <div class="u-align-left u-form-group u-form-submit">
                            <a href="{{route('home.contact')}}" class="u-btn u-btn-submit u-button-style u-custom-color-2 u-custom-font u-text-body-alt-color u-btn-1">Gửi</a>
